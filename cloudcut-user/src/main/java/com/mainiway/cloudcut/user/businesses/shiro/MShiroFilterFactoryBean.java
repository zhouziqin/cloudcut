...
/**
 * ***************************************************************************
 *模块名 : MShiroFilterFactoryBean
 *文件名 : MShiroFilterFactoryBean.java
 *创建时间 : 2016年10月14日
 *实现功能 : 自定义的shiro拦截器
 *作者 : Administrator
 *版本 : v0.0.1
...
public class MShiroFilterFactoryBean extends ShiroFilterFactoryBean{
    ...
    private final class MSpringShiroFilter extends AbstractShiroFilter {
        ...
        protected void doFilterInternal(ServletRequest servletRequest, ServletResponse servletResponse,
            ...
            // 因为ShiroFilter 拦截所有请求（我们配置了urlPattern 为 * ，当然你也可以在那里精确的添加要处理的路径，这样就不需要这个类了），而在每次请求里面都做了session的读取和更新访问时间等操作，这样在集群部署session共享的情况下，数量级的加大了处理量负载。
            // 所以我们这里将一些能忽略的请求忽略掉。

package com.mainiway.cloudcut.commodity.interceptor;
...
//			return false;
//		}
//		//2.判断redis中该用户类型是否为工厂用户
//		FactoryUserEntity factoryUser = redisCacheService.get(String.valueOf(ticket),
...
//		}
	...
	public void afterCompletion(
		...
		if(e!=null){
			...
			String jsonStr = Jackson.obj2json(ro);
			if (Tools.notEmpty(request.getParameter("callback"))) {
				jsonStr = request.getParameter("callback") + "(" + jsonStr + ")";
			}

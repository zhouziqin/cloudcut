package com.mainiway.cloudcut.commodity;
...
import com.mainiway.cloudcut.commodity.interceptor.UserSecurityInterceptor;
import com.mainiway.cloudcut.common.redis.RedisService;

@Configuration //配置控制
@ComponentScan(basePackages={"com.mainiway.cloudcut.dao","com.project.cloudcut.db.model","com.mainiway.cloudcut.common","com.mainiway.cloudcut.factory"}) //组件扫描
@RestController

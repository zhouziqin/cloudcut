package com.mainiway.cloudcut.api.web;
...
@Configuration //配置控制
@ComponentScan(basePackages={"com.mainiway.cloudcut.dao","com.mainiway.cloudcut.db.model","com.mainiway.cloudcut.common","com.mainiway.cloudcut.api.web"}) //组件扫描
@RestController
